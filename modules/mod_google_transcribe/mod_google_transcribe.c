...
SWITCH_STANDARD_API(transcribe2_function)
{
    ...
    TRANSCRIBE_EVENT_RESULTS = TRANSCRIBE_EVENT_RESULTS + "2" ;
    TRANSCRIBE_EVENT_END_OF_UTTERANCE = TRANSCRIBE_EVENT_END_OF_UTTERANCE + "2" ;
    TRANSCRIBE_EVENT_START_OF_TRANSCRIPT = TRANSCRIBE_EVENT_START_OF_TRANSCRIPT + "2" ;
    TRANSCRIBE_EVENT_END_OF_TRANSCRIPT = TRANSCRIBE_EVENT_END_OF_TRANSCRIPT + "2" ;
    TRANSCRIBE_EVENT_NO_AUDIO_DETECTED = TRANSCRIBE_EVENT_NO_AUDIO_DETECTED + "2" ;
    TRANSCRIBE_EVENT_MAX_DURATION_EXCEEDED = TRANSCRIBE_EVENT_MAX_DURATION_EXCEEDED + "2" ;
    TRANSCRIBE_EVENT_PLAY_INTERRUPT = TRANSCRIBE_EVENT_PLAY_INTERRUPT + "2" ;
	if (zstr(cmd) || 
